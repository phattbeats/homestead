...
function computeLayout(enabledKeys) {
  ...
  //
  // `route` remains the deep-link URL for frame-mode modules (the
  // legacy PHA-2204 contract — used by clients that deep-link to
  // /porch.html, etc.). The static handler 404s if the file is
  // missing (PHA-2557 catch-all tightening) — it does NOT fall back
  // to the SPA shell.
