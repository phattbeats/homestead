...
//
// Lists (`lists`) is `{}` for v0 — there is no `lists` table yet. The
// shape in the design doc includes `groceries` as the worked example;
// that table will be added under a separate issue (a homestead-1899
// follow-up is the obvious home). Empty object signals "no lists yet"
// to the caller without breaking the §7 contract.
